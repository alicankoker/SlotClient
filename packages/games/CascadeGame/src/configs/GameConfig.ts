...
export class GameConfig extends BaseGameConfig {
    ...
    public readonly GRID_LAYOUT: GridLayoutConfig = {
        ...
        rowsAboveMask: 0,              // Number of rows above visible area
        rowsBelowMask: 0,              // Number of rows below visible area
        totalRows: function () {
    ...
    public readonly BACKEND: BackendConfig = {
        ...
        USER_ID: import.meta.env.DEV ? "694a7b48a707ff33db2e0d16" : new URLSearchParams(window.location.search).get("session") || undefined,
    };
    ...
    public readonly GRID: GridConfig = {
        ...
        bufferRows: {
            above: 0,               // 2 buffer rows above for smooth scrolling
            below: 0                // 2 buffer rows below for smooth scrolling
        }
    };
