...
export class GameConfig extends BaseGameConfig {
    ...
    private sh = this.REFERENCE_SPRITE_SYMBOL.height + this.REFERENCE_SPACING.vertical - 15;
    private sw = this.REFERENCE_SPRITE_SYMBOL.width + this.REFERENCE_SPACING.horizontal - 5;
    ...
    public readonly REFERENCE_NUMBER_POSITION = { x: -this.sw * 2.675, y: -(this.sh + this.sh / 2.1) };

    public readonly NUMBER_POSITION_MULTIPLIER = 66;
